        ...
        <div class="row py-4 pb-0 pb-sm-4 align-items-center ">
                ...
                <div class="search-bar border rounded-2 px-3 border-dark-subtle">
                    <form id="search-form" class="text-center d-flex align-items-center" action="" method="">
                        <input type="text" class="form-control border-0 bg-transparent"
                            placeholder="Tìm kiếm hơn 10,000 mẫu kính Lumos chính hãng..." />
            ...
            <div
                ...
                <div class="support-box text-end d-none d-xl-block">
                    ...
                    <h5 class="mb-0">0909-686-868</h5>
                </div>
                <div class="support-box text-end d-none d-xl-block">
                    <span class="fs-6 secondary-font text-muted">Email</span>
                    <h5 class="mb-0">support@lumos.vn</h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body justify-content-between">
                    <select class="filter-categories border-0 mb-0 me-5">
                        ...
                        <option>Kính cận Lumos</option>
                        <option>Kính râm Lumos</option>
                        <option>Kính áp tròng Lumos</option>
                        <option>Phụ kiện Lumos</option>
                    </select>
                    ...
                    <ul class="navbar-nav menu-list list-unstyled d-flex gap-md-3 mb-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="pages">
                                ...
                                <li><a href="404.html" class="dropdown-item">Lỗi 404</a></li>
                                <li><a href="style.html" class="dropdown-item">Phong cách Lumos</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="promotion.html" class="nav-link">Khuyến mãi</a>
                        </li>
                    </ul>
                    ...
                    <div class="d-none d-lg-flex align-items-end">
                        <ul class="d-flex justify-content-end list-unstyled m-0">
                            ...
                            <li class="">
                                <a href="cart.html" class="mx-3" data-bs-toggle="offcanvas"
